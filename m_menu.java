...
public class m_menu extends ExpandableListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       getExpandableListView().setBackgroundResource(R.drawable.bg3);
       ...
       // getExpandableListView().set
        ...
        getExpandableListView().setOnGroupClickListener(new OnGroupClickListener() {
			...
			public boolean onGroupClick(ExpandableListView parent, View v,
				...
				Toast.makeText(m_menu.this, ((TextView)v).getText().toString(), Toast.LENGTH_SHORT).show();
				return false;
			}
		});
        ...
        getExpandableListView().setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				Toast.makeText(m_menu.this, ((TextView)v).getText().toString(), Toast.LENGTH_LONG).show();
				String s=((TextView)v).getText().toString();
				Intent i =new Intent (m_menu.this, m_order.class);
				i.putExtra("order", s);
				startActivity(i);
				return false;
			}
    ...
    public class MyExpandableListAdapter extends BaseExpandableListAdapter {
    	...
    	private String[] groups = { "Starters-10mins", "Soups-10mins","North Indian Food-15mins","Chinese-15mins", "Sandwiches-10mins", "Cold Drinks-5mins","Juice-5mins","Pastries-15mins" };
        ...
        public TextView getGenericView() {
            ...
            TextView textView = new TextView(m_menu.this);
